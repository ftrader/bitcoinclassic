...
class PruneTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.nodes.append(start_node(0, self.options.tmpdir, ["-maxreceivebuffer=20000","-blockmaxsize=2000000", "-checkblocks=5"], timewait=900))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-maxreceivebuffer=20000","-blockmaxsize=2000000", "-checkblocks=5"], timewait=900))

        # Create node 2 to test pruning
        self.nodes.append(start_node(2, self.options.tmpdir, ["-maxreceivebuffer=20000","-prune=950"], timewait=900))
    ...
    def create_chain_with_staleblocks(self):
        ...
        for j in xrange(12):
            ...
            self.nodes[0]=start_node(0, self.options.tmpdir, ["-maxreceivebuffer=20000","-blockmaxsize=2000000", "-checkblocks=5"], timewait=900)
            self.sync_block_time()
